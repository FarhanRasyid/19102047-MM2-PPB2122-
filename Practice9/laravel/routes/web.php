...
Route::post('/student', 'StudentController@store')->name('store')->middleware('login_auth');;
Route::get('/student/create', 'StudentController@create')->name('create')->middleware('login_auth');;
Route::get('/student', 'StudentController@index')->name('index')->middleware('login_auth');;
